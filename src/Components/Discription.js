...
class Discription extends Component {
  ...
  render() {
    ...
    const genre = this.props.genre.map(temp => {
        return (
            <span key = {temp} style = {badges}>{temp}</span>
        )
    })
   
    return (
      <div className = "discription">
         <p style = {Title} className = "ZombieFont">{this.props.name}</p>
        ...
        I Try to get the description but i can not find inside the API Response , So I writing this Sorry :(
         ...
         <div style = {BottomIcon} >
             ...
             <p style = { {color:"green" , fontWeight:"lighter" , fontSize:"10px"} }>WILL WATCH <br/>(100)</p>
            </div>
           
            <div style = {center}>
            <i style = {iconorange} className="fa fa-thumbs-up"></i>
            <p style = { {color:"orange" , fontWeight:"lighter" , fontSize:"10px"} }>MAY BE <br/>(0)</p>
            </div>
             
             
            <div style = {center}>
            <i style = {iconred} className="fa fa-thumbs-up"></i>
            <p style = { { color:"red" , fontWeight:"lighter" , fontSize:"10px"} }>WON'T WATCH <br/>(10)</p>    
            </div>
